"""Legacy macOS Flask/CLI chat harness backed directly by llama.cpp.

This script does not perform retrieval. Prefer the FastAPI gateway launcher for
RAG-backed local testing.
"""
